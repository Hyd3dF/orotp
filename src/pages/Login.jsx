...
import { MessageCircle, Eye, EyeOff, ShieldCheck, Zap } from 'lucide-react'
...
export default function Login() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden px-4 py-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.14),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.10),transparent_28%)]" />
      <div className="pointer-events-none absolute left-10 top-10 h-36 w-36 rounded-full bg-primary/10 blur-3xl" />
      <div className="pointer-events-none absolute right-10 bottom-10 h-36 w-36 rounded-full bg-accent/10 blur-3xl" />
        ...
        <div className="grid w-full gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="hidden rounded-[2rem] border border-white/60 bg-white/65 p-8 shadow-[0_25px_70px_rgba(15,23,42,0.08)] backdrop-blur-xl lg:block">
            ...
            <h1 className="brand-font mt-6 text-5xl font-bold leading-[0.95] text-text">
              Sohbet daha temiz, daha hızlı, daha düzenli.
            </h1>
            <p className="mt-5 max-w-md text-base leading-7 text-text-secondary">
              Hesabına güvenli şekilde gir, sohbetlerine ve paylaşımlarına devam et.
              Tasarım sade, akış hızlı, deneyim daha profesyonel.
            </p>
            ...
            <div className="mt-8 space-y-3">
              <div className="rounded-2xl border border-white/70 bg-white/80 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-text">Güvenli oturum</p>
                    <p className="text-sm text-text-secondary">
                      Supabase Auth ile yönetilen giriş akışı.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/70 bg-white/80 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-text">Hızlı geri dönüş</p>
                    <p className="text-sm text-text-secondary">
                      Giriş sonrası otomatik olarak akış sayfasına geçersin.
                    </p>
                  </div>
                </div>
              </div>
